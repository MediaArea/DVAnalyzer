...
#############################################################################
# AVPS_DV_Analyzer
if test -e AVPS_DV_Analyzer/Project/GNU/CLI/configure; then
...
# Going home
cd $Home
echo "AVPS_DV_Analyzer executable is in AVPS_DV_Analyzer/Project/GNU/CLI"
echo "For installing, cd AVPS_DV_Analyzer/Project/GNU/CLI && make install"