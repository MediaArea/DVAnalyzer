...
void GUI_Main_AppleXMLIFv5::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GUI_Main_AppleXMLIFv5::staticMetaObjectExtraData = {
...
const QMetaObject GUI_Main_AppleXMLIFv5::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_GUI_Main_AppleXMLIFv5,
      qt_meta_data_GUI_Main_AppleXMLIFv5, &staticMetaObjectExtraData }
};
